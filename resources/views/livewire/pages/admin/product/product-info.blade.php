<div class="grid gap-6 lg:grid-cols-1 lg:gap-8">
    ...
    >
        ...
        <div class="pt-3 sm:pt-5">
            ...
            <div
                ...
                <div class="flex flex-col justify-between p-4 leading-normal">
                    ...
                    <div class="flex items-center justify-between mt-4">
                        <span class="text-3xl font-bold text-gray-900 dark:text-white">Authorized: {{$product->auth? 'yes' : 'no'}}</span>
                    </div>
                </div>
            </div>
            </p>
        ...
        <div class="mt-12 flex justify-between">
            <div>
                <h2 class="text-white text-2xl">Owner: <br>
                    {{$product->owner()->fullname}}</h2>
            </div>
            <div>
                <h2 class="text-white text-2xl">Not Owner: <br>
                    @foreach($product->nonOwner() as $user)
                    {{$user->fullname}}
                    @endforeach
                </h2>
            </div>
